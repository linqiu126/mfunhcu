...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-07-01 10:12:52
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `t_f4icm_test` (
  `sid` int(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `t_f6pm_test` (
  `sid` int(4) NOT NULL AUTO_INCREMENT,
  `testinfo` char(10) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=75 ;
...
CREATE TABLE IF NOT EXISTS `t_f7ads_test` (
  `sid` int(4) NOT NULL AUTO_INCREMENT,
  `testinfo` char(10) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=75 ;
...
CREATE TABLE IF NOT EXISTS `t_f8psm_test` (
  `sid` int(4) NOT NULL AUTO_INCREMENT,
  `testinfo` char(10) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=75 ;
...
CREATE TABLE IF NOT EXISTS `t_f9gism_test` (
  `sid` int(4) NOT NULL AUTO_INCREMENT,
  `testinfo` char(10) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=75 ;
...
CREATE TABLE IF NOT EXISTS `t_fxprcm_test` (
  `sid` int(4) NOT NULL AUTO_INCREMENT,
  `testinfo` char(10) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=75 ;
