...
'{"button":[
                ...
                {"name":"关于",
                    "sub_button":[{"type":"click","name":"版本信息","key":"CLICK_VERSION"},
                                  ...
                                  {"type":"view","name":"H5页面","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx32f73ab219f56efb&redirect_uri=http://mfuncard.sinaapp.com/wechat/jsp/H5.php&response_type=code&scope=snsapi_base&state=1#wechat_redirect"}]
                }
         ]
 }';
