...
define("MSG_ID_L4NBIOT_IGMUI_TO_NBIOT_OPR_METER_DL_READ_CNT_DATA", $index++);
define("MSG_ID_L4NBIOT_IGMUI_TO_NBIOT_OPR_METER_DL_WRITE_DATA", $index++);
define("MSG_ID_L4NBIOT_IGMUI_TO_NBIOT_OPR_METER_DL_WRITE_ADDR", $index++);
define("MSG_ID_L4NBIOT_IGMUI_TO_NBIOT_OPR_METER_DL_WRITE_DEVICE_SYN", $index++);
