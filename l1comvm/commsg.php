...
define("MSG_ID_L2SDK_HCU_TO_L2SNR_HSMMP", 8);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_HUMID", 9);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_NOISE", 10);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_PM25", 11);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_TEMP", 12);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_WINDDIR", 13);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_WINDSPD", 14);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_AIRPRS", 15);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_ALCOHOL", 16);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_CO1", 17);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_HCHO", 18);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_TOXICGAS", 19);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_LIGHTSTR", 20);
define("MSG_ID_L2SDK_HCU_TO_L2SNR_RAIN", 21);
