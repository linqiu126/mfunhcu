...
//L2CODEC
define("MSG_ID_L2CODEC_PRIVATE_GTJY_DATA_INCOMING", $index++);
define("MSG_ID_L2CODEC_WSDL_YCJK_INCOMING", $index++);
...
define("MSG_ID_L4COMUI_TO_L3F4_CAMERARESET", $index++);
...
/*************************自己更改起始处**********************************************/
define("MSG_ID_L4FAAMUI_TO_L3F11_BUYCONSUMABLES",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_CONSUMABLESTABLES",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_CONSUMABLESHISTORY",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETCONSUMABLESPURCHASE",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_CONSUMABLESPURCHASEMOD",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_CONSUMABLESPUTCHASEDEL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_PRODUCTSTOCKNEW",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETPRODUCTEMPTYSTOCK",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETPRODUCTWEIGHTANDSIZE",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETPRODUCTSTOCKLIST",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_PRODUCTSTOCKDEL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_PRODUCTSTOCKTABLE",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETPRODUCTSTOCKDETAIL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_PRODUCTSTOCKREMOVALNEW",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_PRODUCTSTOCKTRANSFER",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_PRODUCTSTOCKHISTORY",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETPRODUCTSTOCKHISTORYDETAIL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_MATERIALSTOCKNEW",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETMATERIALSTOCKLIST",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETMATERIALEMPTYSTOCK",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_MATERIALSTOCKDEL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_MATERIALSTOCKTABLE",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETMATERIALSTOCKDETAIL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_MATERIALSTOCKINCOMENEW",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_MATERIALSTOCKREMOVANEW",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_MATERIALSTOCKHISTORY",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETMATERIALSTOCKHISTORYDETAIL",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_METERIALSTOCKINCOMEMOD",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_METERIALSTOCKREMOVAMOD",$index++);
...
define("MSG_ID_L4FAAMUI_TO_L3F11_GETPRINT",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETCONSUMABLESVENDORLIST",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_GETCONSUMABLESTYPELIST",$index++);

//水产管理
define("MSG_ID_L4FAAMUI_TO_L3F11_SEAFOODINFO",$index++);
define("MSG_ID_L4FAAMUI_TO_L3F11_SEAFOODAUDIT",$index++);
