...
//定义各测量值告警门限
define("MFUN_L3APL_F3DM_TH_ALARM_NOISE", 70);
define("MFUN_L3APL_F3DM_TH_ALARM_HUMID", 80);
define("MFUN_L3APL_F3DM_TH_ALARM_TEMP", 45);
define("MFUN_L3APL_F3DM_TH_ALARM_PM25", 151); //101-150是轻度污染，151-200是中度污染，201-300是重度污染，>300是严重污染。
    ...
    static $mfunUserGradeArrayConst = array(
        MFUN_USER_GRADE_LEVEL_0 => array(
            ...
            'actionauth'=>array(
                ...
                'ConsumablesTable' => 'true',
                'ConsumablesHistory' => 'true',
                'GetConsumablesPurchase' => 'true',
                'ConsumablesPurchaseMod' => 'true',
                'ConsumablesPurchaseDel' => 'true',
                'ProductStockNew' => 'true',
                'GetProductWeightAndSize' => 'true',
                'GetProductStockList' => 'true',
                'GetProductEmptyStock' => 'true',
                'ProductStockTable' => 'true',
                'ProductStockDel' => 'true',
                'GetProductStockDetail' => 'true',
                'ProductStockTransfer' => 'true',
                'ProductStockHistory' => 'true',
                'MaterialStockNew' => 'true',
                'GetMaterialStockList' => 'true',
                'GetMaterialEmptyStock' => 'true',
                'MaterialStockDel' => 'true',
                'MaterialStockTable' => 'true',
                'GetMaterialStockDetail' => 'true',
                'MaterialStockIncomeNew' => 'true',
                'MaterialStockRemovalNew' => 'true',
                'MaterialStockHistory' => 'true',
                'GetMaterialStockHistoryDetail' => 'true',
                'MaterialStockIncomeMod' => 'true',
                'MaterialStockRemovalMod' => 'true',
                'MaterialStockRemovalDel' => 'true',
                'GetProductStockHistoryDetail' => 'true',
                'ProductStockRemovalMod' => 'true',
