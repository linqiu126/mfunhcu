...
define ("MFUN_WORKING_PROGRAM_NAME_UNIQUE_GTJY", "MFUN_PRG_GTJY");      //国通教育 NBIOT物联网
define ("MFUN_WORKING_PROGRAM_NAME_UNIQUE_FDWQ", "MFUN_PRG_FDWQ");      //复旦卫勤
define ("MFUN_WORKING_PROGRAM_NAME_UNIQUE_FAAM", "MFUN_PRG_FAAM");      //工厂辅助管理
define ("MFUN_WORKING_PROGRAM_NAME_UNIQUE_BFZN", "MFUN_PRG_BFZN");      //波峰智能
...
define ("MFUN_MAIN_ENTRY_CRON", "MFUN_MAIN_ENTRY_CRON");       //CRON定时任务入口
define ("MFUN_MAIN_ENTRY_SOCKET", "MFUN_MAIN_ENTRY_SOCKET");   //Swoole socket监听消息入口
define ("MFUN_MAIN_ENTRY_IOT_STDXML", "MFUN_MAIN_ENTRY_IOT_STDXML");
define ("MFUN_MAIN_ENTRY_IOT_HUITP", "MFUN_MAIN_ENTRY_IOT_HUITP");
define ("MFUN_MAIN_ENTRY_IOT_JSON", "MFUN_MAIN_ENTRY_IOT_JSON");
define ("MFUN_MAIN_ENTRY_WECHAT", "MFUN_MAIN_ENTRY_WECHAT");          //微信公众号入口
define ("MFUN_MAIN_ENTRY_WECHAT_XCX", "MFUN_MAIN_ENTRY_WECHAT_XCX");  //微信小程序入口
...
define ("MFUN_MAIN_ENTRY_GTJY_UI", "MFUN_MAIN_ENTRY_GTJY_UI");
...
define ("MFUN_MAIN_ENTRY_FDWQ_UI", "MFUN_MAIN_ENTRY_FDWQ_UI");
define ("MFUN_MAIN_ENTRY_FAAM_UI", "MFUN_MAIN_ENTRY_FAAM_UI");
...
define ("MFUN_MAIN_ENTRY_GTJY_NBIOT", "MFUN_MAIN_ENTRY_GTJY_NBIOT");
...
define("MFUN_TECH_PLTF_WECHAT_DEVICE_TEXT","MFUN_TECH_PLTF_WECHAT_DEVICE_TEXT"); //DEVICE_TEXT //用于区分WECHAT->IOT_STDXML的处理内容及过程
define("MFUN_TECH_PLTF_WECHAT_DEVICE_EVENT","MFUN_TECH_PLTF_WECHAT_DEVICE_EVENT"); //DEVICE_EVENT //用于区分WECHAT->IOT_STDXML的处理内容及过程
define("MFUN_TECH_PLTF_WECHAT_MENU_CLICK","MFUN_TECH_PLTF_WECHAT_MENU_CLICK"); //MENU_CLICK //用于区分WECHAT->IOT_STDXML的处理内容及过程
...
define("MFUN_TECH_PLTF_HCUGX_HUITP","MFUN_TECH_PLTF_HCUGX_HUITP"); //HCU HUITP
...
define("MFUN_PRJ_HCU_JSON", "MFUN_PRJ_HCU_JSON");
...
define("MFUN_PRJ_IHU_EMCWXUI", "MFUN_PRJ_IHU_EMCWXUI");
define("MFUN_PRJ_HCU_AQYCUI", "MFUN_PRJ_HCU_AQYCUI");
define("MFUN_PRJ_HCU_AQYCWX", "MFUN_PRJ_HCU_AQYCWX");
define("MFUN_PRJ_HCU_AQYCCU", "MFUN_PRJ_HCU_AQYCCU");
define("MFUN_PRJ_HCU_FHYSUI", "MFUN_PRJ_HCU_FHYSUI");
define("MFUN_PRJ_HCU_FHYSWX", "MFUN_PRJ_HCU_FHYSWX");
define("MFUN_PRJ_HCU_FDWQUI", "MFUN_PRJ_HCU_FDWQUI");
define("MFUN_PRJ_HCU_GTJYUI", "MFUN_PRJ_HCU_GTJYUI");
define("MFUN_PRJ_HCU_BFSCUI", "MFUN_PRJ_HCU_BFSCUI");
define("MFUN_PRJ_HCU_TBSWRUI", "MFUN_PRJ_HCU_TBSWRUI");
define("MFUN_PRJ_HCU_FAAMWX", "MFUN_PRJ_HCU_FAAMWX");
define("MFUN_PRJ_HCU_FAAMUI", "MFUN_PRJ_HCU_FAAMUI");
...
if (isset($_SERVER['SERVER_NAME']))
{
    ...
    switch($server_name)
    {
        ...
        case "www.jingdong.com.cn": //京东云
            ...
            define("MFUN_MQ_RABBIT_ROUTE_KEY", "key_1");
            break;
        case "120.55.125.100": //小慧test server
