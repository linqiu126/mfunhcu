...
define("HUITP_IEID_UNI_SW_PACKAGE_BODY_MAX_LEN", 130);
...
class classL2codecHuitpIeDict
{
      public static $huitpIeFormatArrayConst = array(
          ...
          //软件版本体
          HUITP_IEID_uni_sw_package_body                  => array("format"=>"A4ieId/A4ieLen/A4segValidLen/A4segCheckSum/260swPkgBody","len"=>"134","name"=>"HUITP_IEID_uni_sw_package_body"),
