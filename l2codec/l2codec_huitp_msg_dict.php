...
class classL2codecHuitpMsgDict
{
    public static $mfunL2codecHuitpMsgArrayConst = array(
        ...
        HUITP_MSGID_uni_inventory_req => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA000
        HUITP_MSGID_uni_inventory_resp => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA080
        //0xA081
        HUITP_MSGID_uni_inventory_report => array("MSGNAME" => "HUITP_MSGID_uni_inventory_report",
            "MSGIE" => array(HUITP_IEID_uni_com_req,
                            HUITP_IEID_uni_inventory_element)),
        HUITP_MSGID_uni_inventory_confirm => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA001

        //软件版本体
        HUITP_MSGID_uni_sw_package_min => array("MSGNAME" => "HUITP_MSGID_uni_sw_package_min","MSGIE" => array()),  //0xA100
        HUITP_MSGID_uni_sw_package_req => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA100
        HUITP_MSGID_uni_sw_package_resp => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA180
        HUITP_MSGID_uni_sw_package_report => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA181
        HUITP_MSGID_uni_sw_package_confirm => array("MSGNAME" => "","MSGIE" => array(HUITP_IEID_uni_com_req)),  //0xA101
