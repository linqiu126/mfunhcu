...
function get_minute_list(date){
    ...
    myDate.setMonth(parseInt(input[1])-1);	//���� Date �������·� (0 ~ 11)��
    myDate.setFullYear(parseInt(input[0]));	//���� Date �����е���ݣ���λ���֣���
    myDate.setHours(0);	//���� Date �����е�Сʱ (0 ~ 23)��
    myDate.setMinutes(0);	//���� Date �����еķ��� (0 ~ 59)��
    myDate.setSeconds(0);
