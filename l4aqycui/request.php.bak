...
*/
	...
	array_push($alarmlist,$map8);
    $vcr_list= array();// HYJ should modify it to a stand alone address
    for($i=0;$i<10;$i++){
        $map=array(
           'vcrname'=> "录像".(string)$i,
           'vcraddress'=> "127.0.0.1/"
...
*/
    ...
    RESPONSE:
    	$body=array(
            'video'=> "http://127.0.0.1/dist/video/video_view.html",
            'camera'=>"http://127.0.0.1/dist/video/camera_view.html"
    	);
        $retval=array(
            'status'=>'true',
    		'ret'=>$body,
