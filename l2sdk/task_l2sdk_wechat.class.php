            ...
            case "CLICK":
                switch ($object->EventKey)
                {
                    ...
                    case "CLICK__EMC_HIS":
                        ...
                        $content[] = array("Title"=>"辐射累积值", "Description"=>"", "PicUrl"=>"", "Url" =>"http://mfuncard.sinaapp.com/wechat/l4emcwxui/EmcAllData.php?id=".$object->FromUserName);
                        $content[] = array("Title"=>"PM2.5累积值", "Description"=>"", "PicUrl"=>"", "Url" =>"http://mfuncard.sinaapp.com/wechat/l4emcwxui/PMAllData.php?id=".$object->FromUserName);
                        $content[] = array("Title"=>"近一月辐射累计值", "Description"=>"", "PicUrl"=>"", "Url" =>"http://mfuncard.sinaapp.com/wechat/l4emcwxui/EmcAccumulationInfo_1M.php?id=".$object->FromUserName);
                        $content[] = array("Title"=>"近三月辐射累计值", "Description"=>"", "PicUrl"=>"", "Url" =>"http://mfuncard.sinaapp.com/wechat/l4emcwxui/EmcAccumulationInfo_3M.php?id=".$object->FromUserName);
                        break;
