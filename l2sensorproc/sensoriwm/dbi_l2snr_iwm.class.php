...
class classDbiL2snrIwm
{
    ...
    public function dbi_iwm_std_cj188_data_save_buy_amount($cj188address, $equtype, $bc, $thisamount, $accuamount, $remainamount)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwmdata` (cj188address, equtype, buycode, thisamount, accuamount, remainamount)
    ...
    public function dbi_iwm_std_cj188_data_save_address($cj188address, $equtype)
    {
        //建立连接
        $mysqli=new mysqli(MFUN_CLOUD_DBHOST, MFUN_CLOUD_DBUSER, MFUN_CLOUD_DBPSW, MFUN_CLOUD_DBNAME_L1L2L3, MFUN_CLOUD_DBPORT);
        if (!$mysqli) { die('Could not connect: ' . mysqli_error($mysqli)); }
    ...
    public function dbi_iwm_std_cj188_data_save_write_st($cj188address, $equtype, $st)
    {
        //建立连接
        $mysqli=new mysqli(MFUN_CLOUD_DBHOST, MFUN_CLOUD_DBUSER, MFUN_CLOUD_DBPSW, MFUN_CLOUD_DBNAME_L1L2L3, MFUN_CLOUD_DBPORT);
        if (!$mysqli) { die('Could not connect: ' . mysqli_error($mysqli)); }

        $result=$mysqli->query("INSERT INTO `t_l2snr_iwmdata` (cj188address, equtype, st)
    ...
    public function dbi_iwm_std_cj188_data_save_write_buy_amount($cj188address, $equtype, $bc, $buyamount)
    {
        //建立连接
        $mysqli=new mysqli(MFUN_CLOUD_DBHOST, MFUN_CLOUD_DBUSER, MFUN_CLOUD_DBPSW, MFUN_CLOUD_DBNAME_L1L2L3, MFUN_CLOUD_DBPORT);
        if (!$mysqli) { die('Could not connect: ' . mysqli_error($mysqli)); }

        $result=$mysqli->query("INSERT INTO `t_l2snr_iwmdata` (cj188address, equtype, buycode, accuamount)
    ...
    public function dbi_iwm_std_cj188_data_save_key($cj188address, $equtype, $key)
    {
        //建立连接
        $mysqli=new mysqli(MFUN_CLOUD_DBHOST, MFUN_CLOUD_DBUSER, MFUN_CLOUD_DBPSW, MFUN_CLOUD_DBNAME_L1L2L3, MFUN_CLOUD_DBPORT);
        if (!$mysqli) { die('Could not connect: ' . mysqli_error($mysqli)); }

        $result=$mysqli->query("INSERT INTO `t_l2snr_iwmdata` (cj188address, equtype, key)
