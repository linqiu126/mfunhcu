...
class classTaskL2snrToxicgas
{
    ...
    public function func_toxicgas_data_process($platform, $deviceId, $statCode, $content)
    {
        return true;
    }
    ...
    public function mfun_l2snr_toxicgas_task_main_entry($parObj, $msgId, $msgName, $msg)
    {
        ...
        if (empty($msg) == true) {
            ...
            $loggerObj->logger("MFUN_TASK_ID_L2SNR_TOXICGAS", "mfun_l2snr_toxicgas_task_main_entry", $log_time, $log_content);
            echo trim($result);
            return false;
        }
        if (($msgId != MSG_ID_L2SDK_HCU_TO_L2SNR_TOXICGAS) || ($msgName != "MSG_ID_L2SDK_HCU_TO_L2SNR_TOXICGAS")){
