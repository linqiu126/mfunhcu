...
class classTaskL2snrWindspd
{
    ...
    public function mfun_l2snr_windspd_task_main_entry($parObj, $msgId, $msgName, $msg)
    {
        ...
        if (empty($msg) == true) {
            ...
            $loggerObj->mylog($project,"NULL","MFUN_TASK_ID_L2DECODE_HUITP","MFUN_TASK_ID_L2SENSOR_WINDSPD",$msgName,$log_content);
            return false;
        }
        else{
            //解开消息
        ...
        if (!empty($resp)) {
            ...
            $loggerObj->mylog($project,$devCode,"MFUN_TASK_ID_L2SENSOR_WINDSPD","MFUN_TASK_ID_L2ENCODE_HUITP",$msgName,$log_content);
        }
