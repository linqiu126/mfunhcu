...
class classDbiL2snrTemp
{
    ...
    public function dbi_hcu_fhys_temp_status_update($devCode, $statCode, $data)
    {
        ...
        if (($result != false) && ($result->num_rows)>0)
        {
            ...
            $ctrl_key = $apiL2snrCommonServiceObj->byte2string(MFUN_HCU_CMDID_FHYS_TEMP);
            $opt_key = $apiL2snrCommonServiceObj->byte2string(MFUN_HCU_OPT_FHYS_TEMPSTAT_RESP);
    ...
    public function dbi_hcu_fhys_temp_data_process($devCode, $statCode, $data)
    {
        ...
        if (($result != false) && ($result->num_rows)>0)
        {
            ...
            $apiL2snrCommonServiceObj = new classApiL2snrCommonService();
            $ctrl_key = $apiL2snrCommonServiceObj->byte2string(MFUN_HCU_CMDID_FHYS_TEMP);
            $opt_key = $apiL2snrCommonServiceObj->byte2string(MFUN_HCU_OPT_FHYS_TEMPDATA_RESP);
