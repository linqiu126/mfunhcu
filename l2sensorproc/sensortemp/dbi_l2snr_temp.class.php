...
class classDbiL2snrTemp
{
    ...
    private function dbi_l2snr_tempdata_update($mysqli,$devCode,$timeStamp,$tempValue)
    {
    ...
    //更新传感器分钟聚合表
    private function dbi_l2snr_tempdata_minreport_update($mysqli,$devCode,$statCode,$timeStamp,$tempValue)
    {
    ...
    //更新传感器当前报告聚合表
    private function dbi_l2snr_tempdata_currentreport_update($mysqli,$devCode,$statCode,$timeStamp,$tempValue)
    {
    ...
    public function dbi_huitp_msg_uni_temp_data_report($devCode, $statCode, $content)
    {
        ...
        //保存记录到对应l2snr表
        $result1 = $this->dbi_l2snr_tempdata_update($mysqli,$devCode,$timeStamp,$tempValue);
        //更新分钟测量报告聚合表
        $result2 = $this->dbi_l2snr_tempdata_minreport_update($mysqli,$devCode,$statCode,$timeStamp,$tempValue);
        //更新瞬时测量值聚合表
        $result3 = $this->dbi_l2snr_tempdata_currentreport_update($mysqli,$devCode,$statCode,$timeStamp,$tempValue);
