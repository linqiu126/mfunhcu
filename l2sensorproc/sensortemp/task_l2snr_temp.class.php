...
class classTaskL2snrTemp
{
    ...
    public function mfun_l2snr_temp_task_main_entry($parObj, $msgId, $msgName, $msg)
    {
        ...
        if (($msgId != MSG_ID_L2SDK_HCU_TO_L2SNR_TEMP) && ($msgId != MSG_ID_L2SDK_EMCWX_TO_L2SNR_TEMP_DATA_READ_INSTANT) && ($msgId != MSG_ID_L2SDK_EMCWX_TO_L2SNR_TEMP_DATA_REPORT_TIMING)){
