...
class classTaskL2snrTemp
{
    ...
    public function mfun_l2snr_temp_task_main_entry($parObj, $msgId, $msgName, $msg)
    {
        ...
        if (($msgId != MSG_ID_L2SDK_HCU_TO_L2SNR_TEMP) && ($msgId != MSG_ID_L2SDK_EMCWX_TO_L2SNR_TEMP_DATA_READ_INSTANT) && ($msgId != MSG_ID_L2SDK_EMCWX_TO_L2SNR_TEMP_DATA_REPORT_TIMING)&& ($msgId != MSG_ID_L2CODEC_TO_L2SNR_TEMP)){
        ...
        elseif ($msgId == MSG_ID_L2CODEC_TO_L2SNR_TEMP)
        {
            //解开消息
            if (isset($msg["project"])) $project = $msg["project"];
            if (isset($msg["log_from"])) $log_from = $msg["log_from"];
