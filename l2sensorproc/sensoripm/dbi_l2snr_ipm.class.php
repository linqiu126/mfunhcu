...
class classDbiL2snrIpm
{
    ...
    public function dbi_iwm_std_cj188_data_save_price($cj188address, $equtype, $price1, $volume1, $price2, $volume2, $price3)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwm_data_cj188` (cj188address, equtype, price1, volume1, price2, volume2, price3)
    ...
    public function dbi_iwm_std_cj188_data_save_bill_date($cj188address, $equtype, $billdate)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwm_data_cj188` (cj188address, equtype, billdate)
    ...
    public function dbi_iwm_std_cj188_data_save_read_date($cj188address, $equtype, $readdate)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwm_data_cj188` (cj188address, equtype, readdate)
    ...
    public function dbi_iwm_std_cj188_data_save_buy_amount($cj188address, $equtype, $bc, $thisamount, $accuamount, $remainamount)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwm_data_cj188` (cj188address, equtype, bc, thisamount, accuamount, remainamount)
    ...
    public function dbi_iwm_std_cj188_data_save_key_ver($cj188address, $equtype, $keyver)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwm_data_cj188` (cj188address, equtype, keyver)
    ...
    public function dbi_iwm_std_cj188_data_save_addressr($cj188address, $equtype)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_iwm_data_cj188` (cj188address, equtype)
