...
class classDbiL2snrIgm
{
    ...
    public function dbi_igm_std_cj188_data_save($cj188address, $equtype, $curaccuvolume, $curaccuvolumeunit, $todayaccuvolume, $todayaccuvolumeunit, $realtime, $st)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_igm_data_cj188` (cj188address, equtype, currentaccuvolume, currentaccuvolumeuint, todayaccuvolume, todayaccuvolumeuint, realtime, st)
    ...
    public function dbi_igm_std_cj188_data_save_last_month($cj188address, $equtype, $curaccuvolume, $curaccuvolumeunit, $lastmonth)
    {
        ...
        $result=$mysqli->query("INSERT INTO `t_l2snr_igm_data_cj188` (cj188address, equtype, todayaccuvolume, todayaccuvolumeuint, lastmonth)
