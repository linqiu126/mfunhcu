            ...
            switch($msg)
            {
               ...
               var retval={
                ...
                case "ProjDel":  //删除一个项目
                    ...
                    $parObj->mfun_l1vm_msg_send(MFUN_TASK_ID_L4FHYS_UI, MFUN_TASK_ID_L3APPL_FUM3DM, MSG_ID_L4AQYCUI_TO_L3F3_PROJDEL, "MSG_ID_L4AQYCUI_TO_L3F3_PROJDEL",$input);
                    break;
                ...
                */
                ...
                case "AlarmType":  //获取所有传感器类型
                    if (isset($_GET["user"])) $user = trim($_GET["user"]); else  $user = "";
                    $input = array("user" => $user);
                    $parObj->mfun_l1vm_msg_send(MFUN_TASK_ID_L4FHYS_UI, MFUN_TASK_ID_L3APPL_FUM3DM, MSG_ID_L4AQYCUI_TO_L3F3_ALARMTYPE, "MSG_ID_L4AQYCUI_TO_L3F3_ALARMTYPE",$input);
                    break;
               ...
               */
                ...
                */
                ...
                case "HcuSwUpdate": //Delete the user
                    ...
                    $parObj->mfun_l1vm_msg_send(MFUN_TASK_ID_L4FHYS_UI, MFUN_TASK_ID_L3APPL_FUM1SYM, MSG_ID_L4AQYCUI_TO_L3F4_SWUPDATE, "MSG_ID_L4AQYCUI_TO_L3F4_SWUPDATE",$input);
                    break;
...
/*********************************智能云锁新增处理 Start*********************************************/
                ...
                case "StopScale": //临时用于BFSC关闭组合秤
                    ...
                    if (!empty($body))
                        if (isset($body["StatCode"])) $statCode = trim($body["StatCode"]); else  $statCode = "";
                    $input = array("uid" => $uid, "statcode" => $statCode);
                    $parObj->mfun_l1vm_msg_send(MFUN_TASK_ID_L4BFSC_UI, MFUN_TASK_ID_L3APPL_FUM4ICM, MSG_ID_L4BFSCUI_TO_L3F4_WEIGHTCLOSE, "MSG_ID_L4BFSCUI_TO_L3F4_WEIGHTCLOSE",$input);
                    break;
