...
class classTaskL3aplF9gism
{
    ...
    public function mfun_l3apl_f9gism_task_main_entry($parObj, $msgId, $msgName, $msg)
    {
        ...
        if (empty($msg) == true) {
            ...
            $loggerObj->mylog("NULL","NULL","NULL","MFUN_TASK_ID_L3APPL_FUM9GISM",$msgName,$log_content);
            return false;
        }
        else{
            //解开消息
        ...
        if (!empty($resp)) {
            ...
            $loggerObj->mylog($project,$user,"MFUN_TASK_ID_L3APPL_FUM9GISM","MFUN_TASK_VID_L4UI_ECHO",$msgName,$log_content);
